import StyledHideSidebarIcon from "./HideSidebarIcon.styled"
import StyledShowSidebarIcon from "./ShowSidebarIcon.styled"

const ToggleSidebarIcon = ({ activated }: { activated: boolean }) => {
	return (
		<>
			{activated ? (
				<StyledHideSidebarIcon
					width="18"
					height="16"
